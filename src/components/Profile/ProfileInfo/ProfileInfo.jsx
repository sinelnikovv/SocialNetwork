      ...
      <div className={s.content}>
        ...
        <div className={s.info}>
          ...
          <div className={s.contacts}>
            ...
            {props.profile.contacts.facebook && <a href={props.profile.contacts.facebook} className={s.contact}>
            ...
            {props.profile.contacts.github && <a href={props.profile.contacts.github} className={s.contact}>
            <div className={s.logo}>
            ...
            {props.profile.contacts.instagram && <a href={props.profile.contacts.instagram} className={s.contact}>
            <div className={s.logo}>
            ...
            {props.profile.contacts.mainLink && <a href={props.profile.contacts.mainLink} className={s.contact}>
            <div className={s.logo}>
            ...
            {props.profile.contacts.twitter && <a href={props.profile.contacts.twitter} className={s.contact}>
            <div className={s.logo}>
            ...
            {props.profile.contacts.vk && <a href={props.profile.contacts.vk} className={s.contact}>
            <div className={s.logo}>
            ...
            {props.profile.contacts.website && <a className={s.contact} href={props.profile.contacts.website}>
            <div className={s.logo}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                </svg>
            ...
            {props.profile.contacts.youtube && <a className={s.contact} href={props.profile.contacts.youtube}>
            <div className={s.logo}>
